...
<head>
    ...
    <meta name="description" content="The system will allow the customerto register online, then the information of the customerwill be validated. After registration the customerwill be allowed to login into the system. The customerwill then be allowed to choose the kind of truck she/he want to use, then the customerwill be required to enter the current location of his/her staff and destination location.">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="register_admin.php">Register Admin</a>
