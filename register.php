...
<nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
        <div class="container"><a class="navbar-brand" href="./index.php">Booking System</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="register_driver.php">Register Admin</a>
...
<?php include 'includes/session.php'; ?>
    ...
    <header class="masthead" style="background-image:url('assets/img/header-bg.jpg');">
        <div class="container">
            <div class="intro-text" style="padding: 50px">
            <?php
                ...
                <form class="bootstrap-form-with-validation" action="signup.php" method="POST" onsubmit="return sendForm();">
                    ...
                    <div class="form-group"><label for="address">Home Address</label><input class="form-control" type="text" id="address" name="address" required></div>
                    <div class="form-group"><label for="age">Age</label><input class="form-control" type="text" id="age" name="age" onkeypress="return /[0-9]/i.test(event.key)" maxlength="3" required></div>
                    <div class="form-group">
                        <label for="gender">Gender</label>
                        <select class="form-control" type="check" id="gender" name="gender"  required>\
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4"><span class="copyright">Copyright&nbsp;© Booking System 2020</span></div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
                        <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
                        <li class="list-inline-item"><a href="https://m.facebook.com/photo.php?fbid=104156011524658&id=104143501525909&set=a.104150858191840&source=48"><i class="fa fa-facebook"></i></a></li>
